...
export function scene_stage(game: Game) {
    ...
    instantiate(game, [
        ...
        render2d("garnek11"),
        order(1),
        collide2d_static(Layer.PotatoPeel, 2),
    ...
    instantiate(game, [
        ...
        render2d("garnek21"),
        order(1),
        collide2d_static(Layer.PotatoBoil, 2),
        rigid_body2d(RigidKind.Static, 1.5),
        grabbable(),
    ]);
    ...
    for (let i = 0; i < 5; i += 1) {
        instantiate(game, [
            ...
            render2d("sloik"),
            collide2d_static(Layer.Obstacle, 1.3),
            rigid_body2d(RigidKind.Static, 1.5),
            grabbable(),
        ]);
    }
    ...
    for (let i = 0; i < dynamic_count; i++) {
        instantiate(game, [
            ...
            collide2d_dynamic(1, Layer.Obstacle | Layer.PotatoBoil),
